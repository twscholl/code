...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 152.0, 236.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 277.0, 48.0, 22.0 ],
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 320.0, 330.0, 158.0, 22.0 ],
					"text" : "buffer~ drumloop jongly.wav"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 266.75, 196.0, 50.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 239.0, 261.0, 29.5, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 266.75, 223.0, 167.0, 23.0 ],
...
,
									"text" : "param vol.drumloop @value 0.",
									"varname" : "vol.drumloop"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 239.0, 121.0, 56.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 406.0, 164.0, 258.0, 23.0 ],
...
,
									"text" : "buffer~ drumloop @file jongly.wav @channels 2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 239.0, 164.0, 152.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 239.0, 336.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
,
					"patching_rect" : [ 161.0, 314.0, 40.0, 22.0 ],
					"rnboattrcache" : 					{
						"vol.drumloop" : 						{
							"label" : "vol.drumloop",
							"isEnum" : 0,
...
,
					"saved_object_attributes" : 					{
						"optimization" : "O1",
						"parameter_enable" : 1,
						"uuid" : "06122df3-b239-11ee-adf3-4618c3bb8d35"
					}
,
					"snapshot" : 					{
...
,
							"__presetid" : "06122df3-b239-11ee-adf3-4618c3bb8d35"
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "untitled",
									"origin" : "06122df3-b239-11ee-adf3-4618c3bb8d35",
									"type" : "rnbo",
									"subtype" : "",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "untitled",
										"filename" : "untitled_20240113_1.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "4984e486505ea31ecd48e27e395cc337"
									}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 159.0, 398.0, 45.0, 45.0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "jongly.wav",
				"bootpath" : "~/Documents/GitHub/code/rnbo/sample",
				"patcherrelativepath" : ".",
				"type" : "WAVE",
				"implicit" : 1
			}
, 			{
				"name" : "untitled_20240113_1.maxsnap",
